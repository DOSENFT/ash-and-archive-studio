...
| 8 | **Core §19 complete through step 6 (Binding)** — the Codex bench is empty without archive+binding | core workstream | steps 3 ✅ → 4 ✅ (§6 Binding, 49/49, 2026-07-16) → 5 (§7 Charter) at minimum for a working Codex | 🟡 step 5 next |
