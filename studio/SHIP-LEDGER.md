...
| 8 | **Core §19 complete through step 6 (Binding)** — the Codex bench is empty without archive+binding | core workstream | steps 3 ✅ (35/35, 2026-07-16) → 4 (§6 Binding, building now) → 5 (§7 Charter) at minimum for a working Codex | 🟡 step 4 building |
